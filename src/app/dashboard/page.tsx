...
const DOCS = [
  { name: "Standard_Layout_Notes.pdf", date: "Jun 22", size: "1.2 MB", status: "Ready" },
  { name: "Sentence_Transformers_Specs.txt", date: "Jun 21", size: "340 KB", status: "Ready" },
  { name: "Vector_DB_Prisma_Schema.sql", date: "Jun 19", size: "12 KB", status: "Ready" },
  { name: "RAG_Knowledge_Flow.md", date: "Jun 15", size: "85 KB", status: "Ready" },
];

const ACTIVITY = [
  { q: "What is RAG flow in pgvector?", doc: "RAG_Knowledge_Flow.md", score: "94.2%", ms: "140ms", ago: "5m" },
  { q: "Prisma schema setup details", doc: "Vector_DB_Prisma_Schema.sql", score: "88.6%", ms: "210ms", ago: "1h" },
  { q: "How do transformers embed text?", doc: "Sentence_Transformers_Specs.txt", score: "91.8%", ms: "245ms", ago: "4h" },
];
...
export default function DashboardPage() {
  return (
    <AppShell title="Dashboard" subtitle="Workspace overview · 5 documents indexed">
              ...
              {ACTIVITY.map((a, i) => (
                ...
                >
                  <div className="flex items-start justify-between gap-2 mb-1">
                    ...
                    <span className="text-[9px] flex-shrink-0 mt-0.5" style={{ color: "var(--text-3)" }}>
                      {a.ago} ago
                    </span>
                  </div>
